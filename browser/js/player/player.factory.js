...
juke.factory('PlayerFactory', function ($rootScope) {
  ...
  player.showCurrentSong = function(){
    var currSong = player.getCurrentSong();
    console.log(player.getCurrentSong())
    console.log(currSong.artists);
    var artistArray = currSong.artists.map(function(artistObj){
      return artistObj.name;
    });

    var returnedString = artistArray.join(', ') + "- "
    + currSong.name;
